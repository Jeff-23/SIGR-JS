...
try {
  ...
  $home = Invoke-WebRequest -UseBasicParsing -Uri $base -TimeoutSec 10
  if ($home.StatusCode -ne 200 -or $home.Content -notmatch '<div id="root"') { throw 'El frontend React no está disponible.' }
