...
type Menu = { restaurante: string; sucursal: string; mesa: { numero: string }; modoQr: QrMode; pedidosHabilitados: boolean; requiereAceptacion: boolean; categorias: { id: number; nombre: string; productos: Product[] }[] };
