...
export function QrOrdersPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const [requestsResponse, modeResponse] = await Promise.all([
