...
export function QrOrdersPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const requestsResponse = await api.get<QrRequest[]>("/pedidos-qr", { params: { sucursalId: branchId } });
